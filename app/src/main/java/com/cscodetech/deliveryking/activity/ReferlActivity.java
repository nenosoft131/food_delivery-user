...
import com.cscodetech.deliveryking.BuildConfig;
import com.cscodetech.deliveryking.R;
import com.cscodetech.deliveryking.model.ResponseMessge;
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("1")) {
                ...
                if (restResponse.getResult().equalsIgnoreCase("true")) {
                    ...
                    txtWalletname.setText("Earn "+sessionManager.getStringData(SessionManager.currency)+ restResponse.getSignupcredit()+" For Each");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.txt_copy:
                ...
                Toast.makeText(ReferlActivity.this, "Refer code copy", Toast.LENGTH_LONG).show();
                break;
            case R.id.img_back:
                finish();
                break;
