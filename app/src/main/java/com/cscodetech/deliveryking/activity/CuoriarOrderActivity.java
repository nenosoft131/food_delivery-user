...
import com.cscodetech.deliveryking.model.CourierOrder;
import com.cscodetech.deliveryking.model.CourierOrderlist;
...
public class CuoriarOrderActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    ItemAdp itemAdp;
    List<CourierOrderlist> orderHistories = new ArrayList<>();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cuoriarorder);
        ButterKnife.bind(this);
        custPrograssbar = new CustPrograssbar();
        sessionManager = new SessionManager(CuoriarOrderActivity.this);
    ...
    private void getOrder() {
        custPrograssbar.prograssCreate(CuoriarOrderActivity.this);
    ...
    public void callback(JsonObject result, String callNo) {
        try {
            ...
            if (callNo.equalsIgnoreCase("1")) {
                Gson gson = new Gson();
                CourierOrder orderH = gson.fromJson(result.toString(), CourierOrder.class);
    ...
    public void dataset(List<CourierOrderlist> s) {
        ...
        if (!s.isEmpty()) {
            ...
            gridLayoutManager = new StaggeredGridLayoutManager(1, 1);
            myRecyclerView.setLayoutManager(gridLayoutManager);
            itemAdp = new ItemAdp(CuoriarOrderActivity.this, s);
    ...
    public class ItemAdp extends RecyclerView.Adapter<ItemAdp.ViewHolder> {
        ...
        Context mContext;
        List<CourierOrderlist> lists;

        public ItemAdp(Context context, List<CourierOrderlist> s) {
        ...
        public void onBindViewHolder(ViewHolder holder, int i) {
            ...
            CourierOrderlist history = lists.get(i);
            ...
            holder.txtTotal.setText(sessionManager.getStringData(SessionManager.currency) + history.getTotal());
            ...
            holder.txtInfo.setOnClickListener(v -> startActivity(new Intent(CuoriarOrderActivity.this, CourierOrderDetailsActivity.class).putExtra("oid", history.getId())));
            holder.txtCancel.setOnClickListener(v -> {
                AlertDialog myDelete = new AlertDialog.Builder(CuoriarOrderActivity.this)
