...
public class RestaurantsAdp extends RecyclerView.Adapter<RestaurantsAdp.MyViewHolder> {
    ...
    public RestaurantsAdp(Context mContext, List<RestDataItem> categoryList, final RecyclerTouchListener listener) {
        this.mContext = mContext;
        this.itelList = categoryList;
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        RestDataItem item = itelList.get(position);
