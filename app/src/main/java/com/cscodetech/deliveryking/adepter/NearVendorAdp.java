...
public class NearVendorAdp extends RecyclerView.Adapter<NearVendorAdp.MyViewHolder> {
    ...
    public NearVendorAdp(Context mContext, List<RestDataItem> categoryList, final RecyclerTouchListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_nearvendor, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.lvlItmeclik.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                listener.onNearVendorItem(item.getRestId(), position);
            }
        });
