...
public class RestDataItem{
	...
	@SerializedName("rest_num_review")
	private String restNumReview;
	...
	public void setRestCostfortwo(String restCostfortwo){
		this.restCostfortwo = restCostfortwo;
	}
	...
	public void setRestDeliverytime(String restDeliverytime){
		this.restDeliverytime = restDeliverytime;
	}
	...
	public String getRestNumReview() {
		return restNumReview;
	}

	public void setRestNumReview(String restNumReview) {
		this.restNumReview = restNumReview;
	}
